...
Thus we wanted to provide backward simulations of several interactively created scenarios inbetweening the current Chartreuse section and its restoration. Running this cross section in our interactive recursion creates several restoration scenarios which we encode into a story tree (see section ~\ref{sub:storytel}) similarly to \cite{lidal}. Each path of the tree corresponds to one animation of our inbetweening and each branch corresponds to the simulation of one or several events. The resulting output story tree is represented in Figure ~\ref{maingoal}:
 \begin{figure}[H]
	\centering
	\includegraphics[scale=0.65]{mainGoal2.png}
...
\indent 3) Animation of the list of chosen events (section ~\ref{ch:animationmodel})\\
\indent 4) Either looping to the Story Tree process 2) or stopping the process and save the animation in a Vector Animation Complex (VAC) XML file\cite{vac} \\
...
\centering
	...
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite0.png}}
	\caption{Starting Cross Section}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite1.png}}
	\caption{Un-Sediment yellow layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite2.png}}
	\caption{Un-Sediment green khaki layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite3.png}}
	\caption{Un-Fault the two blocks, sliding step}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite4.png}}
	\caption{Un-Erode green layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite5.png}}
	\caption{Un-Erode red layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite6.png}}
	\caption{Un-Sediment red layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite7.png}}
	\caption{Un-Sediment green layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite8.png}}
	\caption{Un-Sediment light green layer}
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
	\centering
	\fbox{\includegraphics[width=.99\textwidth]{chartreusedroite9.png}}
