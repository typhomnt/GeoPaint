...
\indent 3) Animation of the list of choosen events (section ~\ref{ch:animationmodel})\\
\indent 4) Either looping to the Story Tree process 2) or stoping the process and save the animation in a Vector Animation Complex (VAC) XML file\cite{vac} \\
