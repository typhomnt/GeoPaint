...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{unErodeSpecial.png}
...
The story telling part has also been implemented and represent the most generic part because it is templated and can be used directly to any other context than geology. The \textbf{Story Graph} is a 
\section{Results}
